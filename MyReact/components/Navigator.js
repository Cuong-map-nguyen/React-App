...
class HomeScreen extends React.Component<Props> {
  // bước 2 viết code cho class hay component: làm quen Render
    ...
    let data = {
        tennhap : this.state.text
        } 

    alph = /[a-zA-Z]+/
    if (this.state.text != null && this.state.text != '') {
        if(alph.test(this.state.text)){
            this.state.validate = ''
        } else {
            this.state.validate = 'Please check your input error special characters and number'
        }
        ...
        <ImageBackground source={require('../images/everest1.jpg')} style={styles.div}> 
            ...
            <View style={styles.lg}>
                ...
                <Button
                    ...
                    onPress={()=> this.props.navigation.navigate('getScreen2',data)}
                    title="SAVE & CONTUNUE"
                    color="#3dc05b"
